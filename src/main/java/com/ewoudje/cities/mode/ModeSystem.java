...
import com.ewoudje.cities.version.v1_16_R3.ChunkUtil;
...
public class ModeSystem {
    ...
    private final CityPlayer player;
    ...
    public ModeSystem(boolean clientMode, CityPlayer player, Mode mode, Cities plugin) {
    ...
    public static void register(Cities plugin, ModeHandler modeHandler) {
